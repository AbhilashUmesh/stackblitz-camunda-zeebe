...
`;
  ...
  onChange(event: Event) {
    //   if (event.target) {
    //     this.selectedIndex = 0; //event.target['selectedIndex'] - 1;
    //     this.case.caseType = this.tasklist[this.selectedIndex].variables[4].value;
    //     this.case.caseStatus =
    //       this.tasklist[this.selectedIndex].variables[3].value;
    //     this.case.investigationType =
    //       this.tasklist[this.selectedIndex].variables[5].value;
    //     this.case.caseCreator =
    //       this.tasklist[this.selectedIndex].variables[0].value;
    //     this.case.caseCreatorMail =
    //       this.tasklist[this.selectedIndex].variables[1].value;
    //   }
  }
  ...
  //   this.completetask(
  //     this.tasklist[this.selectedIndex].id,
  //     this.case.caseStatus
  //   );
  // }
  ...
  ngOnInit(): void {
    this.http
      .post(
        `https://ont-1.tasklist.camunda.io/fbba6b47-d14a-4657-96a2-80a95bd5e1b1/api/login?username=demo&password=demo`,
        ''
      )
      .subscribe((data: any) => {});
    this.getclaimedtask();
